...
function parseExpression(regex, i = 0, stopCharacter = "", prevState = null) {
  while (i < regex.length) 
  {
    ...
    else if (regex[i] == "(") 
    {
      ...
      const [groupExit, endIndex] = parseExpression(regex, i + 1, ")", createState());
    ...
    else if (regex[i] == "|")
    {
      ...
      const [rhsExit, endIndex] = parseExpression(regex, i + 1, stopCharacter, createState());
